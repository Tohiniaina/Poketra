<%-- 
    Document   : AjoutStock
    Created on : 11 janv. 2024, 14:56:27
    Author     : Tohy
--%>
...
%>
        <main role="main" class="main-content">
            ...
            <div class="row justify-content-center">
                <div class="col-8">
                <h2 class="page-title">Ajout Stock Matiere</h2>
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <strong class="card-title">Stock Matiere</strong>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form method="post" action="AddStockMatiere">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="simpleinput">Quantité</label>
                                            <input type="number" id="simpleinput" class="form-control" name="quantite" step="0.01">
                                        </div>
                                        <div class="form-group mb-3">
